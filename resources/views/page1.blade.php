...
@section('content')
    ...
    <div class="container-fluid text-center my-2">
        <div class="row">
            <div class="col-md-5">
                <h1 class="text-center title"><strong>Autoridades</strong></h1>
                <div class="border border-danger row mx-2 my-1 aut">
                    <img src="{{asset('images/secretaria.jpg')}}" id="fotosecre" width="100" class="mx-2 my-2">
                    <div class="mx-2 my-2">
                        <h3 class="autoridad"><strong>Secretaría de Justicia</strong></h3>
                        <h4 class="autoridad">Dra. Karina Becerra</h4>
                ...
                <div class="border border-danger row mx-2 my-4 aut">
                    <img src="{{asset('images/yaco.jpg')}}" id="fotoy" width="113" class="mx-2 my-2">
                    <div class="mx-2 my-2">
                        <h3 class="autoridad"><strong>Director de DGPJ</strong></h3>
                        <h4 class="autoridad">Jacob Emanuel Saul</h4>
            ...
            <div class="col-md-7">
                ...
                <div class="aut border border-danger">
                    <h3 class="text-secondary my-4 mx-2">
    ...
    <div class="container-fluid">        
        <div class="row">
            <div class="col-md-6 my-2">
                <h2 class="text-center title"><strong>Comunicado</strong></h2>
            ...
            <div class="col-md-6 my-2 text-md-center">
                <h2 class="title"><strong>Noticias</strong></h2>
        ...
        <hr class="border border-danger">
        <h2 class="my-3 title"><strong>Asociaciones Civiles</strong></h2>
